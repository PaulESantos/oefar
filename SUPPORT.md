...
Thanks for using oefar! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/oefar/issues/new).
...
requests](https://github.com/PaulESantos/oefar/issues) to make sure the
