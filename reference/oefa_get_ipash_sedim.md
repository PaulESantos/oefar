...
Downloads data for dataset 'IPASH - Sedimento' from OEFA by its GUID
(IPASH-SEDIM). Belongs to Data Dictionary section: Evaluación ambiental
\> Evaluación ambiental para la identificación de pasivos ambientales
del subsector hidrocarburos (IPASH).

## Usage

``` r
oefa_get_ipash_sedim(
  limit = NULL,
  offset = NULL,
  ...,
