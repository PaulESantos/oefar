...
Downloads data for dataset 'Componente ambiental Biológico - EAT' from
OEFA by its GUID (COMPO-AMBIE-BIOLO-EAT). Belongs to Data Dictionary
section: Evaluación ambiental \> Evaluación Ambiental Temprana (EAT).

## Usage

``` r
oefa_get_compo_ambie_biolo_eat(
  limit = NULL,
  offset = NULL,
  ...,
