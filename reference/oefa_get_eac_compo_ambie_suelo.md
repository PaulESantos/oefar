...
Downloads data for dataset 'EAC - Componente ambiental Suelo' from OEFA
by its GUID (EAC-COMPO-AMBIE-SUELO). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluaciones ambientales de causalidad (EAC).

## Usage

``` r
oefa_get_eac_compo_ambie_suelo(
  limit = NULL,
  offset = NULL,
  ...,
