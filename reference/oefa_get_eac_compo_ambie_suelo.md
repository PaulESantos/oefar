...
Descarga los datos del conjunto de datos 'EAC - Componente ambiental
Suelo' del OEFA por su GUID (EAC-COMPO-AMBIE-SUELO). Pertenece a la
sección del Diccionario de Datos: Evaluación ambiental \> Evaluaciones
ambientales de causalidad (EAC).
