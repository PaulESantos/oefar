...
Descarga los datos del conjunto de datos 'EAT - Biota (Flora y Fauna)'
del OEFA por su GUID (EAT-FLORA-Y-FAUNA). Pertenece a la sección del
Diccionario de Datos: Evaluación ambiental \> Evaluación Ambiental
Temprana (EAT).

## Usage

``` r
oefa_get_eat_flora_y_fauna(
  limit = NULL,
  offset = NULL,
  ...,
