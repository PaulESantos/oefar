...
Descarga los datos del conjunto de datos 'ISIM - Componente Ambiental
Suelo' del OEFA por su GUID (ISIM-COMPO-AMBIE-SUELO). Pertenece a la
sección del Diccionario de Datos: Evaluación ambiental \> Evaluación
ambiental para la identificación de sitios impactados (ISIM).

## Usage

``` r
oefa_get_isim_compo_ambie_suelo(
  limit = NULL,
  offset = NULL,
  ...,
