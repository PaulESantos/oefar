...
Downloads data for dataset 'EAT - Componente ambiental Suelo' from OEFA
by its GUID (EAT-COMPO-AMBIE-SUELO). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluación Ambiental Temprana (EAT).

## Usage

``` r
oefa_get_eat_compo_ambie_suelo(
  limit = NULL,
  offset = NULL,
  ...,
