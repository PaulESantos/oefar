...
Downloads data for dataset 'Proyectos Normativos Externos' from OEFA by
its GUID (PROYE-NORMA-EXTER). Belongs to Data Dictionary section:
Politicas y Estrategias \> Opiniones técnicas a proyectos normativos.
