...
Descarga los datos del conjunto de datos 'Proyectos Normativos OEFA
2018-2025' del OEFA por su GUID (PROYE-NORMA-OEFA-64027). Pertenece a la
sección del Diccionario de Datos: Politicas y Estrategias \> Proyectos
normativos del OEFA.

## Usage

``` r
oefa_get_proye_norma_oefa_64027(
  limit = NULL,
  offset = NULL,
  ...,
