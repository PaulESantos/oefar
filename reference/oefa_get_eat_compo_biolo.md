...
Descarga los datos del conjunto de datos 'EAT - Biota' del OEFA por su
GUID (EAT-COMPO-BIOLO). Pertenece a la sección del Diccionario de Datos:
Evaluación ambiental \> Evaluación Ambiental Temprana (EAT).

## Usage

``` r
oefa_get_eat_compo_biolo(
  limit = NULL,
  offset = NULL,
  ...,
