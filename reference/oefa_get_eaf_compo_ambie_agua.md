...
Downloads data for dataset 'EAF - Componente ambiental agua' from OEFA
by its GUID (EAF-COMPO-AMBIE-AGUA). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluaciones ambientales focales (EAF).

## Usage

``` r
oefa_get_eaf_compo_ambie_agua(
  limit = NULL,
  offset = NULL,
  ...,
