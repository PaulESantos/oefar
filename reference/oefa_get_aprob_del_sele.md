...
Downloads data for dataset 'Aprobación de la selección de personal' from
OEFA by its GUID (APROB-DEL-SELE). Belongs to Data Dictionary section:
Información Institucional \> Personal.
