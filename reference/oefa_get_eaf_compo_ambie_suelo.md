...
Downloads data for dataset 'EAF - Componente ambiental Suelo' from OEFA
by its GUID (EAF-COMPO-AMBIE-SUELO). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluaciones ambientales focales (EAF).

## Usage

``` r
oefa_get_eaf_compo_ambie_suelo(
  limit = NULL,
  offset = NULL,
  ...,
