...
Descarga los datos del conjunto de datos 'EAF - Componente ambiental
Suelo' del OEFA por su GUID (EAF-COMPO-AMBIE-SUELO). Pertenece a la
sección del Diccionario de Datos: Evaluación ambiental \> Evaluaciones
ambientales focales (EAF).
