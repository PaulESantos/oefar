...
Downloads data for dataset 'EAF - Componente ambiental Aire' from OEFA
by its GUID (EAF-COMPO-AMBIE-AIRE). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluaciones ambientales focales (EAF).

## Usage

``` r
oefa_get_eaf_compo_ambie_aire(
  limit = NULL,
  offset = NULL,
  ...,
