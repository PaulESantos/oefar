...
Downloads data for dataset 'Procedimientos de ejecución coactiva: Multas
ambientales' from OEFA by its GUID (PROCE-DE-EJECU-COACT-14377). Belongs
to Data Dictionary section: Información Institucional \> Recaudación.
