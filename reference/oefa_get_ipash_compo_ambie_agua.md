...
Downloads data for dataset 'IPASH - Componente Ambiental Agua' from OEFA
by its GUID (IPASH-COMPO-AMBIE-AGUA). Belongs to Data Dictionary
...
``` r
oefa_get_ipash_compo_ambie_agua(
  limit = NULL,
  offset = NULL,
  ...,
