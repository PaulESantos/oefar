...
Descarga los datos del conjunto de datos 'Medidas administrativas' del
OEFA por su GUID (MEDID-ADMIN). Pertenece a la sección del Diccionario
de Datos: Supervisión ambiental \> Medidas Administrativas.

## Usage

``` r
oefa_get_medid_admin(
  limit = NULL,
  offset = NULL,
  ...,
