...
Downloads data for dataset 'EAC - Componente ambiental Aire' from OEFA
by its GUID (EAC-COMPO-AMBIE-AIRE). Belongs to Data Dictionary section:
Evaluación ambiental \> Evaluaciones ambientales de causalidad (EAC).

## Usage

``` r
oefa_get_eac_compo_ambie_aire(
  limit = NULL,
  offset = NULL,
  ...,
