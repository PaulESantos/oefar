# Contributing to oefar

This outlines how to propose a change to oefar. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/oefar", fork = TRUE)`.
...
Please note that the oefar project is released with a [Contributor Code
of Conduct](https://paulesantos.github.io/oefar/CODE_OF_CONDUCT.md). By
